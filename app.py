...
from config import slack_client_id, slack_client_secret, slack_oauth_scope
...
def pre_install():
    return f'''<a href="https://slack.com/oauth/authorize?scope={OAUTH_SCOPE}&client_id={CLIENT_ID}"><img alt=""Add to Slack"" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" srcset="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" /></a>'''
